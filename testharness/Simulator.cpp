...
int Simulator::GetControlData(FRCCommonControlData *data, char *userData)
{
	wxMutexLocker mtx(m_controlInterface->lock);
	memcpy(data, &m_controlInterface->controlData, sizeof(FRCCommonControlData));
	return 0;
}
